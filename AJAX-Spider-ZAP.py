...
with open('AJAX-spider_zap_report.html', 'w', encoding='utf-8') as f:
    f.write(report_html)

print('HTML Report generated: AJAX-spider_zap_report.html')

# Convert the HTML report to a PDF
print('Converting HTML report to PDF')
HTML(string=report_html).write_pdf('AJAX-spider_zap_report.pdf')

print('PDF Report generated: AJAX-spider_zap_report.pdf')
